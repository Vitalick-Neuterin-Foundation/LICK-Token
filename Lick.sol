...
contract VITALICKNEUTERIN is Context, IERC20, Ownable, SafeToken {
    // User data Lottery
    struct userData {
        address userAddress;
        uint256 totalWon;
    ...
    address payable public marketingAddress =
        payable(0x050Cc3681084A0c9D90b2B89357327e8cBfFC195); // Marketing Address
    address public deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public lottery = 0xc8E080Ed3a855a3A756382af85b132E0a89f3Df5;
    ...
    uint256 private _tTotal = 17052021 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "VITALICK NEUTERIN";
    string private _symbol = "LICK";
    ...
    uint256 public _maxTxAmountForSell = _tTotal.mul(2).div(1000);
    uint256 private minimumTokensBeforeSwap = _maxTxAmountForSell;
    ...
    uint256 private lotteryTax = 3000000000000000000;

    // Lottery variables.
    uint256 private transactionsSinceLastLottery = 0;
    uint256 public winAmount = 9000000000000000000;
    ...
    constructor() {
        ...
        _isExcludedFromLottery[deadAddress] = true;
    ...
    function _handleLottery(address recipient) private returns (bool) {
        ...
        if (_pot > winAmount) {
            ...
            // You can only win if you own LICK and have 0.001% curculation supply
            uint256 _minBalance = _tTotal.div(100000);

            if (_balanceWinner >= _minBalance) {
                // Reward the winner handsomely.
                transferToAddressETH(payable(lottery), lotteryTax);
